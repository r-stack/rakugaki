...
;(function(window) {
	...
	Segmenter.prototype._init = function() {
		...
		this.pieces.forEach(function(piece, pos) {
			// Bugfix for Chrome. The translateZ needs an initial value otherwise the animation will not work. (this seems to be a anime.js bug - letLs wait for the next version..)
